...
thermostat::DeciCelsius Controller::temperature() const { return temperature_; }

thermostat::DeciCelsius Controller::setpoint() const { return config_.setpoint; }

void Controller::setSetpoint(thermostat::DeciCelsius value) {
