...
// A raw 10-bit ADC reading, kept distinc from a temperature so the two cannot be mixed in arithmetic.
// This exists, to prevent a bug by comparing a count against a setpoint as though the conversion had already happened.    
class AdcCount{
public:
